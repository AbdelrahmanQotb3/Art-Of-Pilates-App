...
part of 'settings_api_client.dart';
...
class _SettingsApiClient implements SettingsApiClient {
  _SettingsApiClient(this._dio, {this.baseUrl, this.errorLogger}) {
  ...
  @override
  Future<DeleteAccountResponse> deleteAccount(int id) async {
    final _extra = <String, dynamic>{};
