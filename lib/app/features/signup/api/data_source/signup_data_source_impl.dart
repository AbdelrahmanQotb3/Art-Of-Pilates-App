...
import 'package:art_of_pilates/generated/l10n.dart';
...
class SignupDataSourceImpl implements SignupDataSourceContract {
  ...
  @override
  Future<BaseResponse<SignupResponse>> signup(String email, String password, String firstName, String lastName) async {
    try {
